...
DetectorFactory.seed = 0  # Optional: make results deterministic
...
def detect_language(text):
    try:
        ...
        print(f"[⚠️ Warning] Language detection failed: {e}. Defaulting to 'en'.")
        return "en"
    except Exception as e:
        print(f"[⚠️ Unexpected error] during language detection: {e}. Defaulting to 'en'.")
        return "en"
...
def test_translate():
    ...
    # result = translate(real_data_test_2, target_lang="Chinese")
    # print(result)

    real_data_test_3 = """
Speaker 1: So I have like several plans for this weekend. I'm traveling to I might go to Perth probably, to what is it called? Rothwell? Rothcrest? Rothness? Rothness Island Yeah, just see the quokkas So yeah, I think that would be the most wonderful thing there is to do

Speaker 2: that's what it's like
    """
    print("\nTesting Swinburne University of Technology - Hawthorn Campus 3")
    result = translate(real_data_test_3, target_lang="Chinese")
    print(result)
